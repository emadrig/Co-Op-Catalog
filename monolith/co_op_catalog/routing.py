...
from games.consumers.battleship_consumer import BattleshipMatchConsumer
...
websocket_urlpatterns = [
    ...
    re_path(r'^ws/TicTacToe/(?P<match>[^/]+)/$', TTTMatchConsumer.as_asgi()),
    re_path(r'^ws/Battleship/(?P<match>[^/]+)/$', BattleshipMatchConsumer.as_asgi()),
]
